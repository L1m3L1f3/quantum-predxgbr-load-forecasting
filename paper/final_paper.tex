...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{../results/paper_comparison/all_datasets_mape_plot.png}
    \caption{MAPE comparison across all datasets and evaluated models.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{../results/paper_comparison/all_datasets_r2_plot.png}
    \caption{$R^2$ comparison across all datasets and evaluated models.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{../results/paper_comparison/paper_vs_our_best_mape.png}
    \caption{PredXGBR paper MAPE compared with the best proposed result on each dataset.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{../results/paper_comparison/local_xgboost_vs_hybrid_quantum.png}
